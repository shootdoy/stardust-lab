// BEST-B25 재계산 — **전투태그B(★4·★5)** 용. ★6 만 빼고 A 판과 똑같이 돌린다.
// ⚠ ★4 는 기술 위력이 대부분 미상이라 기본 100 으로 계산된다 — 결과를 A 판만큼 믿지 말 것.
// 규칙(찬스 기본값·KHP 등)이 바뀌면 이걸 돌려 const BESTB25 를 갱신한다.
